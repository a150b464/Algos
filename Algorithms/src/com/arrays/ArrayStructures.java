package com.arrays;
//Linear searches works best if you want to find all values
//Bubble sort sorts in such a way that element right of the index value is sorted
//Selection sorts finds the minimum element and places it at the bottom position
//Insertion sort is bit more complex
public class ArrayStructures {
	...
	public void bubbleSort() {
		...
		for (int i = arraySize - 1; i > 1; i--) {
			...
			// other. If the value is they are
			// swapped
